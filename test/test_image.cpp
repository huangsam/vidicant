...
TEST(ImageHandlerTest, IsGrayscaleTrue) {
    ...
    EXPECT_CALL(*mockLoader, imread("gray.jpg")).WillOnce(::testing::Return(grayImage));
...
TEST(ImageHandlerTest, IsGrayscaleFalse) {
    ...
    EXPECT_CALL(*mockLoader, imread("color.jpg")).WillOnce(::testing::Return(colorImage));
...
TEST(ImageHandlerTest, GetAverageBrightness) {
    ...
    EXPECT_CALL(*mockLoader, imread("bright.jpg")).WillOnce(::testing::Return(image));
...
TEST(ImageHandlerTest, GetNumberOfChannels) {
    ...
    EXPECT_CALL(*mockLoader, imread("channels.jpg")).WillOnce(::testing::Return(image));
...
TEST(ImageHandlerTest, GetEdgeCount) {
    ...
    EXPECT_CALL(*mockLoader, imread("edges.jpg")).WillOnce(::testing::Return(image));
...
TEST(ImageHandlerTest, GetDominantColors) {
    ...
    EXPECT_CALL(*mockLoader, imread("colors.jpg")).WillOnce(::testing::Return(image));
...
TEST(ImageHandlerTest, GetBlurScore) {
    ...
    EXPECT_CALL(*mockLoader, imread("sharp.jpg")).WillOnce(::testing::Return(sharpImage));
